...
export default class PortfolioForm extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      logo: "",
      editMode: false,
      apiUrl: "https://joshuagrover.devcamp.space/portfolio/portfolio_items",
      apiAction: "post"
    };
  ...
  deleteImage(imageType){
    axios.delete(
      ...
      {withCredentials: true}
        ...
        console.log("delteImageEror", error)
      })
  }
  ...
  componentDidUpdate(){
    if(Object.keys(this.props.portfolioToEdit).length > 0){
      ...
      this.setState({
        ...
        url: url || "",
        editMode: true,
        apiUrl: `https://joshuagrover.devcamp.space/portfolio/portfolio_items/${id}`,
        apiAction: "patch",
